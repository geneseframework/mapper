// import { TConstructor, TConstructor } from '../../../../models/t-constructor.model';
...
// import { DeclarationService } from '../../../../services/ast.service';
...
//      */
//     private constructor(classConstructor: TConstructor<T> | string, options?: MapperOptions) {
//         this.implement(classConstructor);
//     }
//
//
//     implement(classConstructor: TConstructor<T> | string): void {
...
//
//
//     private static async getInstance<T>(classConstructor: TConstructor<T> | string): Promise<Mapper<T>> {
...
//
//
//     private static getMapper<T>(classConstructor: TConstructor<T> | string): Mapper<T> {
...
//
//
//     static async create<T>(classConstructor: TConstructor<T> | string, data: boolean): Promise<boolean>
//     static async create<T>(classConstructor: TConstructor<T> | string, data: number): Promise<number>
//     static async create<T>(classConstructor: TConstructor<T> | string, data: string): Promise<string>
//     static async create<T>(classConstructor: TConstructor<T> | string, data: any[]): Promise<T[]>
//     static async create<T>(classConstructor: TConstructor<T> | string, data: any): Promise<T | T[] | PrimitiveElement | ArrayOfPrimitiveElements> {
...
//         } else {
//             const classDeclaration: ClassDeclaration = DeclarationService.getClassDeclaration(mapper.typeName);
//             if (Array.isArray(data)) {
//                 return MapInstanceService.createTypes(data, mapper.typeName, classDeclaration);
//             } else {
//                 return MapInstanceService.generateInstance(data, mapper.typeName, classDeclaration);
//             }
//         }
//     }
//
