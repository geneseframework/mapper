...
// ----------------------------------------------   'DateDeclaration' or DateDeclaration   ------------------------------------------------------
...
testMappers.push(new TestMapper(`['2021-02-19T17:36:53.999Z', '2021-02-19T17:36:53.999Z'] / Date[] / [new Date('2021-02-19T17:36:53.999Z'), new Date('2021-02-19T17:36:53.999Z')]`, 'DateDeclaration[]', ['2021-02-19T17:36:53.999Z', '2021-02-19T17:36:53.999Z'], {expectedValue: [new Date('2021-02-19T17:36:53.999Z'), new Date('2021-02-19T17:36:53.999Z')]}));
...
// -------------------------------------   Object with property of type DateDeclaration-----------------------------------------------
...
testMappers.push(new TestMapper(`{date: 'a'} / DateSpec / {date : 'Invalid Date'}`, DateSpec, {date: 'a'}, {expectedValue: {date : 'Invalid DateDeclaration'}}));
