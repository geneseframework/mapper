...
testMappers.push(new TestMapper(`['2', 3] / ['number', 'string'] & !differentiate / ['2', '3']`, ['number', 'string'],['2', 3], {expectedValue: ['2', '3'], isolate: false, config: {behavior: {differentiateStringsAndNumbers: false}}}));
testMappers.push(new TestMapper(`['a', 3] / ['number', 'string'] & !differentiate / [NaN, '3']`, ['number', 'string'],['a', 3], {expectedValue: [NaN, '3'], isolate: false, config: {behavior: {differentiateStringsAndNumbers: false}}}));
...
testMappers.push(new TestMapper(`[2] / ['string'] && !differentiate / ['2']`, ['string'],[2], {expectedValue: ['2'], isolate: false, config: {behavior: {differentiateStringsAndNumbers: false}}}));
...
testMappers.push(new TestMapper(`['2'] / ['number'] / [2]`, ['number'],['2'], {expectedValue: [2], isolate: false, config: {behavior: {differentiateStringsAndNumbers: false}}}));
...
// testMappers.push(new TestMapper(`['a', ['b', 2]] / TupleStringTupleStringStringSpec & !diff`, 'TupleStringTupleStringStringSpec',['a', ['b', 2]], {isolate: false, config: {behavior: {differentiateStringsAndNumbers: false}}}));
...
// testMappers.push(new TestMapper(`['a', ['b', 'c']] / TupleStringTupleStringNumberSpec / ['a', ['b', NaN]]`, 'TupleStringTupleStringNumberSpec',['a', ['b', 'c']], {expectedValue: ['a', ['b', NaN]], isolate: false, config: {behavior: {differentiateStringsAndNumbers: false}}}));
