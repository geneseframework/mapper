...
import { CatSpec, ClassWithAnySpec,  ClassWithPrimitivesSpec,  IndexableNumberSpec,    IndexableSpec,    OutOfProjectSpec, PersonCatSpec, ValuesByDefault, ValuesOnConstructor } from "../debug/project/src/tests/classes.spec";
...
export function generateInstance<T>(instanceGenerator: InstanceGenerator<T>): T {
    ...
    switch (instanceGenerator.id) {
        ...
        case 'MapTupleService_/users/utilisateur/documents/perso_gilles_fabre/genese/genesemapper/src/services/map-tuple.service.ts':
            ...
            break;
        case 'MapTypeArrayService_/users/utilisateur/documents/perso_gilles_fabre/genese/genesemapper/src/services/map-type-array.service.ts':
            instance = new MapTypeArrayService();
            break;
        ...
        case 'IndexableSpec_/users/utilisateur/documents/perso_gilles_fabre/genese/genesemapper/src/debug/project/src/tests/classes.spec.ts':
            ...
            break;
        case 'IndexableNumberSpec_/users/utilisateur/documents/perso_gilles_fabre/genese/genesemapper/src/debug/project/src/tests/classes.spec.ts':
