...
By default, `@genese/mapper` analyze all the files corresponding to the `tsconfig.json` located at the root of your project. You can change this behavior by two ways :
